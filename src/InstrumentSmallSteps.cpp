...
constexpr BusWords encodeEvenDivisors(uint16_t divisor20000,
                                      uint16_t divisor80)
{
    return {
        uint8_t(uint8_t(fineCode(divisor20000) % 10u) << 4u),
        uint8_t(
...
constexpr BusWords kAt240MHzPlus10Hz = encodeEvenDivisors(40004u, 238u);
constexpr BusWords kAt240MHzPlus100Hz = encodeEvenDivisors(40040u, 238u);
constexpr BusWords kAt240MHzPlus1kHz = encodeEvenDivisors(40400u, 238u);
constexpr BusWords kAt241MHzPlus100Hz = encodeEvenDivisors(40040u, 178u);
...
bool makeSmallStepProgram(uint32_t pointAFrequencyHz, SmallStepProgram* program)
{
    ...
    const BusWords words = encodeEvenDivisors(divisor20000, divisor80);
