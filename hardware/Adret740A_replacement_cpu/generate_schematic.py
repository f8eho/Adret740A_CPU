...
ARDUINO_PINS = (
    Pin("28", "D28 / PA6", "L", panel_pin_y(19), "FP_D0"),
    Pin("29", "D29 / PA7", "L", panel_pin_y(20), "FP_D1"),
    Pin("26", "D26 / PA4", "L", panel_pin_y(21), "FP_D2"),
    Pin("27", "D27 / PA5", "L", panel_pin_y(22), "FP_D3"),
    Pin("24", "D24 / PA2", "L", panel_pin_y(23), "FP_D4"),
    Pin("25", "D25 / PA3", "L", panel_pin_y(24), "FP_D5"),
    Pin("22", "D22 / PA0", "L", panel_pin_y(25), "FP_D6"),
    Pin("23", "D23 / PA1", "L", panel_pin_y(26), "FP_D7"),
    Pin("2", "D2 / PE4 / INT4", "L", panel_pin_y(12), "FP_CA1"),
    Pin("10", "D10 / PB4", "L", panel_pin_y(10), "FP_CA2"),
    Pin("53", "D53 / PB0", "L", panel_pin_y(1), "FP_MODE"),
    Pin("52", "D52 / PB1", "L", panel_pin_y(2), "FP_C"),
    Pin("51", "D51 / PB2", "L", panel_pin_y(3), "FP_B"),
    Pin("50", "D50 / PB3", "L", panel_pin_y(4), "FP_A"),
...
def schematic() -> str:
    ...
    notes = [
        ...
        text_note("Bus panneau : nouveau faisceau sans croisements, inversion compensee par le firmware", 18, 221, "panel-map-note", 0.9),
