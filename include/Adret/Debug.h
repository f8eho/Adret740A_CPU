...
#ifndef ADRET_INSTRUMENT_BUS_BENCH
#define ADRET_INSTRUMENT_BUS_BENCH 0
#endif
...
#if ADRET_INSTRUMENT_BUS_BENCH != 0 && ADRET_INSTRUMENT_BUS_BENCH != 1
#error "ADRET_INSTRUMENT_BUS_BENCH must be 0 or 1"
#endif
